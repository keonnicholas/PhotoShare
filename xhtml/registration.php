<?php
	...
	$conn = mysqli_connect($server, $user, $pass, $dbase);
		...
		header("Location: thankyou.php?fname=$fname&lname=$lname");
        ...
        <div id="body">
            ...
            <div id="reghead-container">
				...
				<div id="login-form-container" onmouseenter="opacityplus()" onclick="formfocus()">
					<form method="POST" id="Logon" name="Logon" action="../members/mhome.php" onsubmit="return validateLogin()">
			...
			<div id="body-text">
				...
				<div class="contactus-text">
					...
					<div id="contact-left">
						...
						<form id="reg_form" name="reg_form" method="post" action="registration.php" onsubmit="return validateReg();">	
							...
							<fieldset id="basicInfoFS">
								...
								<input type="password" name="pwd" id="pwd" onkeyup="check_pwd()" value="<?php echo $pwd;?>"/> <br /><br />
